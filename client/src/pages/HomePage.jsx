      ...
      <div className="border-gray-400 border-4 h-3/4 w-1/2">
        ...
        <div className="flex justify-center items-center flex-col gap-4">
          ...
          <form className="flex justify-center items-center flex-col w-11/12 gap-8 mt-4 mb-6">
            ...
            />
            {error.username && <label className='my-2 text-red-500'>Username cannot be empty!</label>}
            </div>
            <div className="w-full">
            <input
              type="text"
            ...
            />
            {error.roomId && <label className='my-2 text-red-500'>Room ID cannot be empty!</label>}
            </div>
            <button className="bg-green-600 h-10 px-4 py-2 rounded-sm hover:bg-green-400"
              onClick={joinRoom}
            >
              Join
            </button>
          ...
          <p className="text-light">
            ...
            <span className="text-green-500 underline hover:text-green-300 hover:cursor-pointer"
